...
extension UserDefaults {
    ...
    static func registerUserDefaults() {
        ...
        shared.register(defaults: [UserDefaults.Key.serversSort: ServersSort.countryCode.rawValue])
    }
    ...
    static func clearSession() {
        ...
        shared.removeObject(forKey: UserDefaults.Key.customDNS)
        ...
        shared.removeObject(forKey: UserDefaults.Key.antiTrackerDNS)
        shared.removeObject(forKey: UserDefaults.Key.antiTrackerDNSMultiHop)
        shared.removeObject(forKey: UserDefaults.Key.antiTrackerHardcoreDNS)
        shared.removeObject(forKey: UserDefaults.Key.antiTrackerHardcoreDNSMultiHop)
