...
class ControlPanelViewController: UITableViewController {
    ...
    func updateStatus(vpnStatus: NEVPNStatus, animated: Bool = true) {
        ...
        if !Application.shared.connectionManager.reconnectAutomatically && NetworkManager.shared.isNetworkReachable && vpnStatus != lastVPNStatus && (vpnStatus == .connected || vpnStatus == .disconnected) {
            DispatchQueue.delay(0.6) {
